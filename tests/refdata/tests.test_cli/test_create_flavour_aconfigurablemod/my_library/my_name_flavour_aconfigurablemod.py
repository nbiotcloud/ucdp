"""My Name Flavour Aconfigurablemod Module."""
...
class MyNameFlavourAconfigurablemodIoType(u.AStructType):
    """My Name Flavour Aconfigurablemod IO."""

    title: str = "My Name Flavour Aconfigurablemod"
    comment: str = "RX/TX"
...
class MyNameFlavourAconfigurablemodMod(u.AConfigurableMod):
    """My Name Flavour Aconfigurablemod Module."""
    ...
    def _build(self) -> None:
        ...
        core = MyNameFlavourAconfigurablemodCoreMod(parent=self, name="u_core")
