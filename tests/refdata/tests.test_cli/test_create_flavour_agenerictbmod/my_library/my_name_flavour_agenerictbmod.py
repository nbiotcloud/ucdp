...
class MyNameFlavourAgenerictbmodIoType(u.AStructType):
    """My Name Flavour Agenerictbmod IO."""

    title: str = "My Name Flavour Agenerictbmod"
    comment: str = "RX/TX"
...
class MyNameFlavourAgenerictbmodMod(u.AGenericTbMod):
    ...
    def _build(self) -> None:
        ...
        self.add_port(MyNameFlavourAgenerictbmodIoType(), "my_name_flavour_agenerictbmod_i", route="create(u_core/my_name_flavour_agenerictbmod_i)", clkrel=u.ASYNC)
        ...
        core = MyNameFlavourAgenerictbmodCoreMod(parent=self, name="u_core")
...
class MyNameFlavourAgenerictbmodCoreMod(u.ACoreMod):
    """A Simple My Name Flavour Agenerictbmod."""
