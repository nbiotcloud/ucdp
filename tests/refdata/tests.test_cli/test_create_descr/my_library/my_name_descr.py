...
class MyNameDescrIoType(u.AStructType):
    """My Name Descr IO."""

    title: str = "My Name Descr"
    comment: str = "RX/TX"
...
class MyNameDescrMod(u.AMod):
    ...
    def _build(self) -> None:
        ...
        self.add_port(MyNameDescrIoType(), "my_name_descr_i", route="create(u_core/my_name_descr_i)", clkrel=u.ASYNC)
        ...
        core = MyNameDescrCoreMod(parent=self, name="u_core")
...
class MyNameDescrCoreMod(u.ACoreMod):
    """A Simple My Name Descr."""
